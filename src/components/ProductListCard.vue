	...
	>
		<v-list-item>
			<v-list-item-content class="text-left">
				<v-list-item-title class="text-h4 secondary--text mb-4 d-inline-flex">
					{{ product.name }}
						<tech-chip
				...
				<v-list-item-subtitle class="wrap-text text-body-1 mr-3 mb-3 ml-6 font-weight-medium black--text">
					{{ product.memo }}
